...
public class SkillRecyclerviewAdapter extends RecyclerView.Adapter<SkillRecyclerviewAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(SkillRecyclerviewAdapter.ViewHolder holder, int position) {
        ...
        int image = R.drawable.question_mark;
        if(name.equals("Python")) image = R.drawable.python;
        else if(name.equals("Java")) image = R.drawable.java;
        else if(name.equals("C")) image = R.drawable.c;
        else if(name.equals("C++")) image = R.drawable.cpp;
        else if(name.equals("Kotlin")) image = R.drawable.kotlin;
