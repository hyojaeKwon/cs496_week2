    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        try {
            ...
            for (int i = 0; i < user.length(); ++i) {
                ...
                listUser.add(new UserInfo(Uid, Uname, Usay, github, language, -1, Utype));
            }
        } catch (IOException e) {
        ...
        for (int i = 0; i < listUser.size(); i++) {
            ...
            bundle.putInt("Utype", listUser.get(i).getUtype());
        ...
        adapter.setOnItemClickListener(new SkillRecyclerviewAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View v, int position, String skill_name) {
                if (filter.contains(skill_name)) {
                    ...
                    v.setBackgroundColor(Color.parseColor("#C8C9CB"));
                }
